...
- Dodano rekonstrukcję poprzedników dla powtórzonych sesji importu w Repair Manifest Builder, dzięki czemu pierwsza stabilna sesja może zostać `KEEP`, a redundantne fale mogą otrzymać propozycje `DELETE` bez rozluźniania preconditions.
