...
| Według pracowników | `dateFrom`, `dateTo`, `employeeId` | Pracownik; Suma godzin z nadgodzinami; Suma godzin bez nadgodzin; I zmiana; II zmiana; [Brak danych o zmianie — warunkowo]; dynamiczne kolumny rodzajów czasu |
