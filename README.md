...
* [Repair Manifest Builder](docs/duplicate-repair-plan.md) – read-only manifest v2 z planem KEEP/DELETE/REVIEW, snapshotami, fingerprintami i konkretnymi poprzednikami, bez zmian w bazie.
* [Duplicate Repair Executor](docs/duplicate-repair-executor.md) – podsumowanie i zatwierdzanie manifestów v1/v2 oraz read-only stub wykonania wymagający kompletnego v2.
* [Projekt etapu wykonawczego](docs/duplicate-repair-executor-stage4-design.md) – architektura przyszłej transakcyjnej walidacji, soft delete, audytu, idempotencji i recovery; kod wykonawczy nie jest jeszcze wdrożony.
